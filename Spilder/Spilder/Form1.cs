...
namespace Spilder
{
    public partial class Form1 : Form
    {
        ...
        //別學區網址
        private string dofuuURL;

        //帳號、密碼
        private string account, password, folder, dirPath;
        ...
        private string getFormHash(WebClient ct, string url)
        {
        ...
        private string getFormHash(string url)
        {
        ...
        private void GetContent(object id)
        {
            var tid = id.ToString();
            ...
            if (srcString.IndexOf("您已經給他讚了") == -1)
            {
                ...
                //設定點讚post需要的參數
                var para1 = System.Web.HttpUtility.UrlEncode(tid.Substring(4));
                var para2 = System.Web.HttpUtility.UrlEncode(hash);
                var para3 = System.Web.HttpUtility.UrlEncode(post_safecode);
                var para4 = System.Web.HttpUtility.UrlEncode(re_url);
                var para5 = System.Web.HttpUtility.UrlEncode("");
                var para6 = System.Web.HttpUtility.UrlEncode("3");
                var para7 = System.Web.HttpUtility.UrlEncode("true");
            ...
            #endregion 取得感謝頁的post_safecode、re_url
